...
| Local Folder Import | ⚠️ v0.2.2 | Scan and import manually copied folders |
...
### 3.2 v0.2.2 (🚧 IN PROGRESS)

| Item | Description | Status |
|------|-------------|--------|
| **Local Folder Scan** | `GET /api/workspaces/scan` - discover unregistered folders | 🚧 Pending |
| **Local Folder Import** | `POST /api/workspaces/import-local` - register local folder | 🚧 Pending |
| **Scan Local UI** | Button to scan and import manually copied folders | 🚧 Pending |
| **Multi-Source Support** | Handle git repos, plain folders, any source | 🚧 Pending |

### 3.3 Future Enhancements (v0.2.3+)
