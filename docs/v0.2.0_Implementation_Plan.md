...
## 17. v0.2.2 Implementation Plan: Local Folder Import
...
- [ ] `GET /api/workspaces/scan` returns unregistered folders
- [ ] `POST /api/workspaces/import-local` registers local folder
- [ ] UI shows "Scan Local" button
- [ ] Modal displays discovered folders with git info
- [ ] User can set custom display name
- [ ] Imported local folders appear in workspace dropdown
- [ ] Local folders work identically to GitHub imports for sessions/runs
