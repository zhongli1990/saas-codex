...
|---|---------|----------|--------|
| 1 | PostgreSQL persistence for workspaces | High | Pending |
| 2 | PostgreSQL persistence for sessions | High | Pending |
| 3 | PostgreSQL persistence for runs and events | High | Pending |
| 4 | UI workspace dropdown (select from imported) | High | Pending |
| 5 | UI session list and selection | High | Pending |
| 6 | UI run history view | Medium | Pending |
...
- [ ] Workspaces persist across container restarts
- [ ] Sessions persist across container restarts
- [ ] Runs and events persist across container restarts
- [ ] UI shows workspace dropdown with imported workspaces
- [ ] UI shows session list for selected workspace
- [ ] UI allows continuing existing session
- [ ] UI shows run history for selected session
- [ ] Past transcripts can be viewed from persisted events
